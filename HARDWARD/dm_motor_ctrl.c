...
void dm_motor_init(void)
{
	...
	motor[Motor1].ctrl.vel_set 	= 0.f;
	motor[Motor1].ctrl.pos_set 	= motor_YAW_zero;
	motor[Motor1].ctrl.cur_set 	= 0.f;
	motor[Motor1].ctrl.kp_set 	= 0.f;
	motor[Motor1].ctrl.kd_set 	= 0.f;
	...
	motor[Motor2].ctrl.vel_set 	= 0.f;
//	motor[Motor2].ctrl.kp_set=  0.f;
//	motor[Motor2].ctrl.kd_set = 0.f;
	motor[Motor2].ctrl.pos_set 	= L_Pitch_dm;
//	motor[Motor2].ctrl.cur_set 	= 0.f;
	motor[Motor2].ctrl.kp_set   = 2.5f;
	motor[Motor2].ctrl.kd_set 	= 0.8f;
	motor[Motor2].ctrl.tor_set  = 0.f;
	...
	motor[Motor3].ctrl.vel_set 	= 0.f;
	motor[Motor3].ctrl.pos_set 	= S_Pitch_dm;
	motor[Motor3].ctrl.cur_set 	= 0.f;
	motor[Motor3].ctrl.kp_set   = 0.f;
	motor[Motor3].ctrl.kd_set 	= 0.3f;
//	motor[Motor3].ctrl.kd_set 	= 0.f;
	motor[Motor3].ctrl.tor_set  =0.f;
	motor[Motor3].tmp.PMAX		= 12.5f;
	motor[Motor3].tmp.VMAX		= 30.f;
	...
	motor[Motor4].ctrl.vel_set 	= 0.f;
	motor[Motor4].ctrl.pos_set 	= row_dm;
	motor[Motor4].ctrl.cur_set 	= 0.f;
	motor[Motor4].ctrl.kp_set   = 1.8f;
	motor[Motor4].ctrl.kd_set 	= 1.8f;
//	motor[Motor4].ctrl.kp_set   = 0.f;
//	motor[Motor4].ctrl.kd_set 	= 0.f;
	motor[Motor4].ctrl.tor_set  = 0.f;
	...
	motor[Motor5].ctrl.vel_set 	= 0.f;
	motor[Motor5].ctrl.pos_set 	= diff_y_dm;
	motor[Motor5].ctrl.cur_set 	= 0.f;
	motor[Motor5].ctrl.kp_set   = 0.f;
	motor[Motor5].ctrl.kd_set 	= 0.f;
	motor[Motor5].ctrl.tor_set  = 0.f;
	...
	motor[Motor6].ctrl.mode 	= mit_mode;
	motor[Motor6].ctrl.vel_set 	= 0.f;
	motor[Motor6].ctrl.pos_set 	= diff_x_dm;
	motor[Motor6].ctrl.cur_set 	= 0.f;
	motor[Motor6].ctrl.kp_set   = 0.f;
	motor[Motor6].ctrl.kd_set 	= 0.f;
	motor[Motor6].ctrl.tor_set  = 0.f;
	...
	motor[Motor7].ctrl.vel_set 	= 0.f;
	motor[Motor7].ctrl.pos_set 	= zhuazi_dm;
	motor[Motor7].ctrl.cur_set 	= 0.f;
	motor[Motor7].ctrl.kp_set   = 0.f;
	motor[Motor7].ctrl.kd_set 	= 0.f;
	motor[Motor7].ctrl.tor_set  = 0.f;
