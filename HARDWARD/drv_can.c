...
void CAN_Init(CAN_HandleTypeDef *hcan, CAN_Call_Back Callback_Function)
{
    ...
    else if (hcan->Instance == CAN2)
    {
		...
		CAN_Filter_Mask_Config(hcan, CAN_FILTER(13) | CAN_FIFO_0 | CAN_STDID | CAN_DATA_TYPE, 0, 0);
        CAN_Filter_Mask_Config(hcan, CAN_FILTER(14) | CAN_FIFO_1 | CAN_STDID | CAN_DATA_TYPE, 0, 0);
    }
}
...
const motor_measure_t *get_gimbal_motor_measure_poi;
