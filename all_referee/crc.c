...
static const uint8_t CRC8_TAB[256] = {
    ...
    0x32, 0x6c, 0x8e, 0xd0, 0x53, 0x0d, 0xef, 0xb1, 0x0f, 0xae, 0x4c, 0x12, 0x91, 0xcf, 0x2d, 0x73,
...
static const uint16_t wCRC_Table[256] = {
    ...
    0x8c48, 0x9dc1, 0xaf5a, 0xbed3, 0xca6c, 0xdb5,  0xe97e, 0xf8f7,
    ...
    0xce4c, 0xdfc5, 0xed5e, 0xfc7,  0x8868, 0x99e1, 0xab7a, 0xbab3,
    0x5285, 0x430c, 0x7197, 0x601e, 0x14a1, 0x0528, 0x37b3, 0x263a,
    0xdecd, 0xcf44, 0xfddf, 0xec56, 0x98e9, 0x8960, 0xbbfb, 0xaa72,
    0x6306, 0x728f, 0x4014, 0x519d, 0x2522, 0x34ab, 0x0630, 0x17b9,
    0xef4e, 0xfec7, 0xcc5c, 0xdd5,  0xa96a, 0xb8e3, 0x8a78, 0x9bf1,
    0x7387, 0x620e, 0x5095, 0x411c, 0x35a3, 0x242a, 0x16b1, 0x0738,
    0xffff, 0xee46, 0xdcdd, 0xcd54, 0x9eb,  0xa862, 0x9af9, 0x8b70,
    0x8408, 0x9581, 0xa71a, 0xb693, 0xcc22, 0xd3a5, 0xe13e, 0xf0b7,
    0x0840, 0x19c9, 0x2b52, 0x3adb, 0x4e64, 0x5fed, 0x6d76, 0x7cff,
    0x9489, 0x8500, 0xb79b, 0xa612, 0xd2ad, 0xc324, 0xf1bf, 0xe036,
    0x18c1, 0x0948, 0x3bd3, 0x2a5a, 0x5ee5, 0x4f6c, 0x7df7, 0x6c7e,
    0xa50a, 0xb483, 0x8618, 0x9791, 0xe32e, 0xf2a7, 0xc03c, 0xd1b5,
    0x2942, 0x38cb, 0x0a50, 0x1bd9, 0x6f66, 0x7eef, 0x4c74, 0x5dfd,
    0xb58b, 0xa402, 0x9699, 0x8710, 0xf3af, 0xe226, 0x0dbd, 0xc134,
...
void Append_CRC16_Check_Sum(uint8_t *pchMessage, uint32_t dwLength)
{
    ...
    uint16_t wCRC = Get_CRC16_Check_Sum(pchMessage, dwLength - 2, CRC16_INIT);
    pchMessage[dwLength - 2] = wCRC & 0xff;
    pchMessage[dwLength - 1] = (wCRC >> 8) & 0xff;
}
